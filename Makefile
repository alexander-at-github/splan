...
# Simple Plan (splan)
bin/splan: src/main.c build/planner.o build/utils.o build/state.o $(BIN_DIR)
	$(CC) $(CFLAGS) -o $@ -I$(BIN_DIR) -I$(LIB_PDDL31_BIN_DIR) $< build/planner.o build/utils.o build/state.o $(LIB_PDDL31) -l$(ANTLR3.4_C_RUNTIME)
